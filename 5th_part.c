...
int fifth_part(void)
{
    int score1 = 0, score2 = 0, score3 = 0, score4 = 0, score5 = 0, score6 = 0, score7 = 0; //각 답변의 점수를 저장할 정수 선언, 초기화
    float score_final = 0; //socre을 모두 더한 값을 저장할 정수 선언, 초기화
    float score_final2 = 0; //socre_fianl에 추가 계산한 값을 저장할 정수 선언, 초기화
    int number1 = 0, number2 = 0, number3 = 0, number4 = 0, number5 = 0, number6 = 0, number7 = 0; //각 질문의 답변을 저장할 정수 선언, 초기화
    ...
    do {
        ...
        else if (number1 == 4)
        {
            ...
            printf("1~5사이의 값을 입력해 주세요.\n"); //else문을 이용해 1~5의 값을 입력받지 않았을 경우 다시 입력하라는 메시지 출력
        }
